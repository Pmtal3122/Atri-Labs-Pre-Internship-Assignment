...
class Atri:
	def __init__(self, state: Any):
		...
		self.Home_About_etc = state["Home_About_etc"]
		self.Flex4 = state["Flex4"]
		self.Flex7 = state["Flex7"]
		self.Flex6 = state["Flex6"]
		self.The_best_place_to_eat_burgers = state["The_best_place_to_eat_burgers"]
		self.Buttons_2 = state["Buttons_2"]
		self.Flex10 = state["Flex10"]
		self.Orange_background = state["Orange_background"]
		self.Order_from_favourite_app = state["Order_from_favourite_app"]
		self.Four_Images = state["Four_Images"]
		self.First_Two_Images = state["First_Two_Images"]
		self.Last_two_images = state["Last_two_images"]
		self.Browse_our_menu1 = state["Browse_our_menu1"]
		self.Menu_Thumbnails = state["Menu_Thumbnails"]
		self.Menu_thumbnail_1 = state["Menu_thumbnail_1"]
		self.Menu_thumbnail_2 = state["Menu_thumbnail_2"]
		self.Menu_thumbnail_3 = state["Menu_thumbnail_3"]
		self.Menu_thumbnail_4 = state["Menu_thumbnail_4"]
		self.Buttons_in_menu1 = state["Buttons_in_menu1"]
		self.About_Us = state["About_Us"]
		self.Image_and_Address = state["Image_and_Address"]
		self.Come_and_visit_us_block = state["Come_and_visit_us_block"]
		self.Flex28 = state["Flex28"]
		self.Flex31 = state["Flex31"]
		self.Flex32 = state["Flex32"]
		self.About_Us_Flex = state["About_Us_Flex"]
		self.About_Us_Buttons = state["About_Us_Buttons"]
		self.Browse_Our_Menu2 = state["Browse_Our_Menu2"]
		self.BOM2_Catalogue_Buttons = state["BOM2_Catalogue_Buttons"]
		self.Catalogue_Row_1 = state["Catalogue_Row_1"]
		self.Catalogue_Row_1_Left = state["Catalogue_Row_1_Left"]
		self.Catalogue_Card_1 = state["Catalogue_Card_1"]
		self.Price_Flex_1 = state["Price_Flex_1"]
		self.Catalogue_Card_2 = state["Catalogue_Card_2"]
		self.Flex41 = state["Flex41"]
		self.Catalogue_Row_1_Right = state["Catalogue_Row_1_Right"]
		self.Flex45 = state["Flex45"]
		self.Flex43 = state["Flex43"]
		self.Flex46 = state["Flex46"]
		self.Flex44 = state["Flex44"]
		self.Catalogue_Row_2 = state["Catalogue_Row_2"]
		self.Catalogue_Row_2_Right = state["Catalogue_Row_2_Right"]
		self.Flex52 = state["Flex52"]
		self.Flex48 = state["Flex48"]
		self.Flex53 = state["Flex53"]
		self.Flex49 = state["Flex49"]
		self.Catalogue_Row_2_Left = state["Catalogue_Row_2_Left"]
		self.Flex54 = state["Flex54"]
		self.Flex50 = state["Flex50"]
		self.Flex55 = state["Flex55"]
		self.Flex51 = state["Flex51"]
		self.BOM2_Buttons = state["BOM2_Buttons"]
		self.Most_Delicious_Burger = state["Most_Delicious_Burger"]
		self.MDB_Left = state["MDB_Left"]
		self.Flex62 = state["Flex62"]
		self.MDB_Right = state["MDB_Right"]
		self.What_Our_Clients_Say_Flex = state["What_Our_Clients_Say_Flex"]
		self.Testimony_Flex = state["Testimony_Flex"]
		self.Testimony_Prev_Flex = state["Testimony_Prev_Flex"]
		self.Testimony_Next_Flex = state["Testimony_Next_Flex"]
		self.Testimony_Main = state["Testimony_Main"]
		self.Flex73 = state["Flex73"]
		self.Profile_Flex = state["Profile_Flex"]
		self.Name_Place_Flex = state["Name_Place_Flex"]
		self.Flex77 = state["Flex77"]
		self.Our_Articles = state["Our_Articles"]
		self.Our_Articles_Headline = state["Our_Articles_Headline"]
		self.Flex80 = state["Flex80"]
		self.OA_All_Cards = state["OA_All_Cards"]
		self.OA_Cards_Left = state["OA_Cards_Left"]
		self.OA_Cards_Right = state["OA_Cards_Right"]
		self.OA_Cards_Right_Row1 = state["OA_Cards_Right_Row1"]
		self.OA_Card = state["OA_Card"]
		self.Flex86 = state["Flex86"]
		self.Flex89 = state["Flex89"]
		self.Flex87 = state["Flex87"]
		self.Flex88 = state["Flex88"]
		self.Book_Your_Table_Now = state["Book_Your_Table_Now"]
		self.BYTN_Left = state["BYTN_Left"]
		self.Flex92 = state["Flex92"]
		self.Flex95 = state["Flex95"]
		self.Flex96 = state["Flex96"]
		self.BYTN_Right = state["BYTN_Right"]
		self.BYTN_Form = state["BYTN_Form"]
		self.BYTN_Form_Row = state["BYTN_Form_Row"]
		self.BYTN_Form_LabelAndInput = state["BYTN_Form_LabelAndInput"]
		...
		self.Follow_Us_On_Insta_Flex = state["Follow_Us_On_Insta_Flex"]
		self.FUOI_Header_Button = state["FUOI_Header_Button"]
		self.Flex113 = state["Flex113"]
		self.FUOI_Images = state["FUOI_Images"]
		self.FUOI_Images_Right = state["FUOI_Images_Right"]
		self.FUOI_Right_Row_1 = state["FUOI_Right_Row_1"]
		self.FUOI_Right_Row2 = state["FUOI_Right_Row2"]
		self.Footer_Flex = state["Footer_Flex"]
		self.Footer_Flex_Left = state["Footer_Flex_Left"]
		self.Flex121 = state["Flex121"]
		self.Footer_Flex_Mid = state["Footer_Flex_Mid"]
		self.Footer_Mid_List = state["Footer_Mid_List"]
		self.Flex124 = state["Flex124"]
		self.Footer_Flex_Right = state["Footer_Flex_Right"]
		...
		self.Order_Online_Button = state["Order_Online_Button"]
		self.Button9 = state["Button9"]
		self.About_Us_Image = state["About_Us_Image"]
		self.TextBox25 = state["TextBox25"]
		self.Location_Icon = state["Location_Icon"]
	...
	@property
	def Titles(self):
		self._getter_access_tracker["Titles"] = {}
		return self._Titles
	@Titles.setter
	def Titles(self, new_state):
		self._setter_access_tracker["Titles"] = {}
		global default_state
		self._Titles = Flex(new_state, default_state["Titles"])

	@property
	def Home_About_etc(self):
		self._getter_access_tracker["Home_About_etc"] = {}
		return self._Home_About_etc
	@Home_About_etc.setter
	def Home_About_etc(self, new_state):
		self._setter_access_tracker["Home_About_etc"] = {}
		global default_state
		self._Home_About_etc = Flex(new_state, default_state["Home_About_etc"])
	...
	@property
	def The_best_place_to_eat_burgers(self):
		self._getter_access_tracker["The_best_place_to_eat_burgers"] = {}
		return self._The_best_place_to_eat_burgers
	@The_best_place_to_eat_burgers.setter
	def The_best_place_to_eat_burgers(self, new_state):
		self._setter_access_tracker["The_best_place_to_eat_burgers"] = {}
		global default_state
		self._The_best_place_to_eat_burgers = Flex(new_state, default_state["The_best_place_to_eat_burgers"])

	@property
	def Buttons_2(self):
		self._getter_access_tracker["Buttons_2"] = {}
		return self._Buttons_2
	@Buttons_2.setter
	def Buttons_2(self, new_state):
		self._setter_access_tracker["Buttons_2"] = {}
		global default_state
		self._Buttons_2 = Flex(new_state, default_state["Buttons_2"])
	...
	def Orange_background(self):
		self._getter_access_tracker["Orange_background"] = {}
		return self._Orange_background
	@Orange_background.setter
	def Orange_background(self, new_state):
		self._setter_access_tracker["Orange_background"] = {}
		global default_state
		self._Orange_background = Flex(new_state, default_state["Orange_background"])

	@property
	def Order_from_favourite_app(self):
		self._getter_access_tracker["Order_from_favourite_app"] = {}
		return self._Order_from_favourite_app
	@Order_from_favourite_app.setter
	def Order_from_favourite_app(self, new_state):
		self._setter_access_tracker["Order_from_favourite_app"] = {}
		global default_state
		self._Order_from_favourite_app = Flex(new_state, default_state["Order_from_favourite_app"])

	@property
	def Four_Images(self):
		self._getter_access_tracker["Four_Images"] = {}
		return self._Four_Images
	@Four_Images.setter
	def Four_Images(self, new_state):
		self._setter_access_tracker["Four_Images"] = {}
		global default_state
		self._Four_Images = Flex(new_state, default_state["Four_Images"])

	@property
	def First_Two_Images(self):
		self._getter_access_tracker["First_Two_Images"] = {}
		return self._First_Two_Images
	@First_Two_Images.setter
	def First_Two_Images(self, new_state):
		self._setter_access_tracker["First_Two_Images"] = {}
		global default_state
		self._First_Two_Images = Flex(new_state, default_state["First_Two_Images"])

	@property
	def Last_two_images(self):
		self._getter_access_tracker["Last_two_images"] = {}
		return self._Last_two_images
	@Last_two_images.setter
	def Last_two_images(self, new_state):
		self._setter_access_tracker["Last_two_images"] = {}
		global default_state
		self._Last_two_images = Flex(new_state, default_state["Last_two_images"])

	@property
	def Browse_our_menu1(self):
		self._getter_access_tracker["Browse_our_menu1"] = {}
		return self._Browse_our_menu1
	@Browse_our_menu1.setter
	def Browse_our_menu1(self, new_state):
		self._setter_access_tracker["Browse_our_menu1"] = {}
		global default_state
		self._Browse_our_menu1 = Flex(new_state, default_state["Browse_our_menu1"])

	@property
	def Menu_Thumbnails(self):
		self._getter_access_tracker["Menu_Thumbnails"] = {}
		return self._Menu_Thumbnails
	@Menu_Thumbnails.setter
	def Menu_Thumbnails(self, new_state):
		self._setter_access_tracker["Menu_Thumbnails"] = {}
		global default_state
		self._Menu_Thumbnails = Flex(new_state, default_state["Menu_Thumbnails"])

	@property
	def Menu_thumbnail_1(self):
		self._getter_access_tracker["Menu_thumbnail_1"] = {}
		return self._Menu_thumbnail_1
	@Menu_thumbnail_1.setter
	def Menu_thumbnail_1(self, new_state):
		self._setter_access_tracker["Menu_thumbnail_1"] = {}
		global default_state
		self._Menu_thumbnail_1 = Flex(new_state, default_state["Menu_thumbnail_1"])

	@property
	def Menu_thumbnail_2(self):
		self._getter_access_tracker["Menu_thumbnail_2"] = {}
		return self._Menu_thumbnail_2
	@Menu_thumbnail_2.setter
	def Menu_thumbnail_2(self, new_state):
		self._setter_access_tracker["Menu_thumbnail_2"] = {}
		global default_state
		self._Menu_thumbnail_2 = Flex(new_state, default_state["Menu_thumbnail_2"])

	@property
	def Menu_thumbnail_3(self):
		self._getter_access_tracker["Menu_thumbnail_3"] = {}
		return self._Menu_thumbnail_3
	@Menu_thumbnail_3.setter
	def Menu_thumbnail_3(self, new_state):
		self._setter_access_tracker["Menu_thumbnail_3"] = {}
		global default_state
		self._Menu_thumbnail_3 = Flex(new_state, default_state["Menu_thumbnail_3"])

	@property
	def Menu_thumbnail_4(self):
		self._getter_access_tracker["Menu_thumbnail_4"] = {}
		return self._Menu_thumbnail_4
	@Menu_thumbnail_4.setter
	def Menu_thumbnail_4(self, new_state):
		self._setter_access_tracker["Menu_thumbnail_4"] = {}
		global default_state
		self._Menu_thumbnail_4 = Flex(new_state, default_state["Menu_thumbnail_4"])

	@property
	def Buttons_in_menu1(self):
		self._getter_access_tracker["Buttons_in_menu1"] = {}
		return self._Buttons_in_menu1
	@Buttons_in_menu1.setter
	def Buttons_in_menu1(self, new_state):
		self._setter_access_tracker["Buttons_in_menu1"] = {}
		global default_state
		self._Buttons_in_menu1 = Flex(new_state, default_state["Buttons_in_menu1"])
	...
	@property
	def Image_and_Address(self):
		self._getter_access_tracker["Image_and_Address"] = {}
		return self._Image_and_Address
	@Image_and_Address.setter
	def Image_and_Address(self, new_state):
		self._setter_access_tracker["Image_and_Address"] = {}
		global default_state
		self._Image_and_Address = Flex(new_state, default_state["Image_and_Address"])

	@property
	def Come_and_visit_us_block(self):
		self._getter_access_tracker["Come_and_visit_us_block"] = {}
		return self._Come_and_visit_us_block
	@Come_and_visit_us_block.setter
	def Come_and_visit_us_block(self, new_state):
		self._setter_access_tracker["Come_and_visit_us_block"] = {}
		global default_state
		self._Come_and_visit_us_block = Flex(new_state, default_state["Come_and_visit_us_block"])
	...
	@property
	def About_Us_Flex(self):
		self._getter_access_tracker["About_Us_Flex"] = {}
		return self._About_Us_Flex
	@About_Us_Flex.setter
	def About_Us_Flex(self, new_state):
		self._setter_access_tracker["About_Us_Flex"] = {}
		global default_state
		self._About_Us_Flex = Flex(new_state, default_state["About_Us_Flex"])

	@property
	def About_Us_Buttons(self):
		self._getter_access_tracker["About_Us_Buttons"] = {}
		return self._About_Us_Buttons
	@About_Us_Buttons.setter
	def About_Us_Buttons(self, new_state):
		self._setter_access_tracker["About_Us_Buttons"] = {}
		global default_state
		self._About_Us_Buttons = Flex(new_state, default_state["About_Us_Buttons"])

	@property
	def Browse_Our_Menu2(self):
		self._getter_access_tracker["Browse_Our_Menu2"] = {}
		return self._Browse_Our_Menu2
	@Browse_Our_Menu2.setter
	def Browse_Our_Menu2(self, new_state):
		self._setter_access_tracker["Browse_Our_Menu2"] = {}
		global default_state
		self._Browse_Our_Menu2 = Flex(new_state, default_state["Browse_Our_Menu2"])

	@property
	def BOM2_Catalogue_Buttons(self):
		self._getter_access_tracker["BOM2_Catalogue_Buttons"] = {}
		return self._BOM2_Catalogue_Buttons
	@BOM2_Catalogue_Buttons.setter
	def BOM2_Catalogue_Buttons(self, new_state):
		self._setter_access_tracker["BOM2_Catalogue_Buttons"] = {}
		global default_state
		self._BOM2_Catalogue_Buttons = Flex(new_state, default_state["BOM2_Catalogue_Buttons"])

	@property
	def Catalogue_Row_1(self):
		self._getter_access_tracker["Catalogue_Row_1"] = {}
		return self._Catalogue_Row_1
	@Catalogue_Row_1.setter
	def Catalogue_Row_1(self, new_state):
		self._setter_access_tracker["Catalogue_Row_1"] = {}
		global default_state
		self._Catalogue_Row_1 = Flex(new_state, default_state["Catalogue_Row_1"])

	@property
	def Catalogue_Row_1_Left(self):
		self._getter_access_tracker["Catalogue_Row_1_Left"] = {}
		return self._Catalogue_Row_1_Left
	@Catalogue_Row_1_Left.setter
	def Catalogue_Row_1_Left(self, new_state):
		self._setter_access_tracker["Catalogue_Row_1_Left"] = {}
		global default_state
		self._Catalogue_Row_1_Left = Flex(new_state, default_state["Catalogue_Row_1_Left"])

	@property
	def Catalogue_Card_1(self):
		self._getter_access_tracker["Catalogue_Card_1"] = {}
		return self._Catalogue_Card_1
	@Catalogue_Card_1.setter
	def Catalogue_Card_1(self, new_state):
		self._setter_access_tracker["Catalogue_Card_1"] = {}
		global default_state
		self._Catalogue_Card_1 = Flex(new_state, default_state["Catalogue_Card_1"])

	@property
	def Price_Flex_1(self):
		self._getter_access_tracker["Price_Flex_1"] = {}
		return self._Price_Flex_1
	@Price_Flex_1.setter
	def Price_Flex_1(self, new_state):
		self._setter_access_tracker["Price_Flex_1"] = {}
		global default_state
		self._Price_Flex_1 = Flex(new_state, default_state["Price_Flex_1"])

	@property
	def Catalogue_Card_2(self):
		self._getter_access_tracker["Catalogue_Card_2"] = {}
		return self._Catalogue_Card_2
	@Catalogue_Card_2.setter
	def Catalogue_Card_2(self, new_state):
		self._setter_access_tracker["Catalogue_Card_2"] = {}
		global default_state
		self._Catalogue_Card_2 = Flex(new_state, default_state["Catalogue_Card_2"])
	...
	@property
	def Catalogue_Row_1_Right(self):
		self._getter_access_tracker["Catalogue_Row_1_Right"] = {}
		return self._Catalogue_Row_1_Right
	@Catalogue_Row_1_Right.setter
	def Catalogue_Row_1_Right(self, new_state):
		self._setter_access_tracker["Catalogue_Row_1_Right"] = {}
		global default_state
		self._Catalogue_Row_1_Right = Flex(new_state, default_state["Catalogue_Row_1_Right"])
	...
	@property
	def Catalogue_Row_2(self):
		self._getter_access_tracker["Catalogue_Row_2"] = {}
		return self._Catalogue_Row_2
	@Catalogue_Row_2.setter
	def Catalogue_Row_2(self, new_state):
		self._setter_access_tracker["Catalogue_Row_2"] = {}
		global default_state
		self._Catalogue_Row_2 = Flex(new_state, default_state["Catalogue_Row_2"])

	@property
	def Catalogue_Row_2_Right(self):
		self._getter_access_tracker["Catalogue_Row_2_Right"] = {}
		return self._Catalogue_Row_2_Right
	@Catalogue_Row_2_Right.setter
	def Catalogue_Row_2_Right(self, new_state):
		self._setter_access_tracker["Catalogue_Row_2_Right"] = {}
		global default_state
		self._Catalogue_Row_2_Right = Flex(new_state, default_state["Catalogue_Row_2_Right"])
	...
	@property
	def Catalogue_Row_2_Left(self):
		self._getter_access_tracker["Catalogue_Row_2_Left"] = {}
		return self._Catalogue_Row_2_Left
	@Catalogue_Row_2_Left.setter
	def Catalogue_Row_2_Left(self, new_state):
		self._setter_access_tracker["Catalogue_Row_2_Left"] = {}
		global default_state
		self._Catalogue_Row_2_Left = Flex(new_state, default_state["Catalogue_Row_2_Left"])
	...
	@property
	def BOM2_Buttons(self):
		self._getter_access_tracker["BOM2_Buttons"] = {}
		return self._BOM2_Buttons
	@BOM2_Buttons.setter
	def BOM2_Buttons(self, new_state):
		self._setter_access_tracker["BOM2_Buttons"] = {}
		global default_state
		self._BOM2_Buttons = Flex(new_state, default_state["BOM2_Buttons"])

	@property
	def Most_Delicious_Burger(self):
		self._getter_access_tracker["Most_Delicious_Burger"] = {}
		return self._Most_Delicious_Burger
	@Most_Delicious_Burger.setter
	def Most_Delicious_Burger(self, new_state):
		self._setter_access_tracker["Most_Delicious_Burger"] = {}
		global default_state
		self._Most_Delicious_Burger = Flex(new_state, default_state["Most_Delicious_Burger"])

	@property
	def MDB_Left(self):
		self._getter_access_tracker["MDB_Left"] = {}
		return self._MDB_Left
	@MDB_Left.setter
	def MDB_Left(self, new_state):
		self._setter_access_tracker["MDB_Left"] = {}
		global default_state
		self._MDB_Left = Flex(new_state, default_state["MDB_Left"])
	...
	@property
	def MDB_Right(self):
		self._getter_access_tracker["MDB_Right"] = {}
		return self._MDB_Right
	@MDB_Right.setter
	def MDB_Right(self, new_state):
		self._setter_access_tracker["MDB_Right"] = {}
		global default_state
		self._MDB_Right = Flex(new_state, default_state["MDB_Right"])

	@property
	def What_Our_Clients_Say_Flex(self):
		self._getter_access_tracker["What_Our_Clients_Say_Flex"] = {}
		return self._What_Our_Clients_Say_Flex
	@What_Our_Clients_Say_Flex.setter
	def What_Our_Clients_Say_Flex(self, new_state):
		self._setter_access_tracker["What_Our_Clients_Say_Flex"] = {}
		global default_state
		self._What_Our_Clients_Say_Flex = Flex(new_state, default_state["What_Our_Clients_Say_Flex"])

	@property
	def Testimony_Flex(self):
		self._getter_access_tracker["Testimony_Flex"] = {}
		return self._Testimony_Flex
	@Testimony_Flex.setter
	def Testimony_Flex(self, new_state):
		self._setter_access_tracker["Testimony_Flex"] = {}
		global default_state
		self._Testimony_Flex = Flex(new_state, default_state["Testimony_Flex"])

	@property
	def Testimony_Prev_Flex(self):
		self._getter_access_tracker["Testimony_Prev_Flex"] = {}
		return self._Testimony_Prev_Flex
	@Testimony_Prev_Flex.setter
	def Testimony_Prev_Flex(self, new_state):
		self._setter_access_tracker["Testimony_Prev_Flex"] = {}
		global default_state
		self._Testimony_Prev_Flex = Flex(new_state, default_state["Testimony_Prev_Flex"])

	@property
	def Testimony_Next_Flex(self):
		self._getter_access_tracker["Testimony_Next_Flex"] = {}
		return self._Testimony_Next_Flex
	@Testimony_Next_Flex.setter
	def Testimony_Next_Flex(self, new_state):
		self._setter_access_tracker["Testimony_Next_Flex"] = {}
		global default_state
		self._Testimony_Next_Flex = Flex(new_state, default_state["Testimony_Next_Flex"])

	@property
	def Testimony_Main(self):
		self._getter_access_tracker["Testimony_Main"] = {}
		return self._Testimony_Main
	@Testimony_Main.setter
	def Testimony_Main(self, new_state):
		self._setter_access_tracker["Testimony_Main"] = {}
		global default_state
		self._Testimony_Main = Flex(new_state, default_state["Testimony_Main"])
	...
	@property
	def Profile_Flex(self):
		self._getter_access_tracker["Profile_Flex"] = {}
		return self._Profile_Flex
	@Profile_Flex.setter
	def Profile_Flex(self, new_state):
		self._setter_access_tracker["Profile_Flex"] = {}
		global default_state
		self._Profile_Flex = Flex(new_state, default_state["Profile_Flex"])

	@property
	def Name_Place_Flex(self):
		self._getter_access_tracker["Name_Place_Flex"] = {}
		return self._Name_Place_Flex
	@Name_Place_Flex.setter
	def Name_Place_Flex(self, new_state):
		self._setter_access_tracker["Name_Place_Flex"] = {}
		global default_state
		self._Name_Place_Flex = Flex(new_state, default_state["Name_Place_Flex"])
	...
	@property
	def Our_Articles_Headline(self):
		self._getter_access_tracker["Our_Articles_Headline"] = {}
		return self._Our_Articles_Headline
	@Our_Articles_Headline.setter
	def Our_Articles_Headline(self, new_state):
		self._setter_access_tracker["Our_Articles_Headline"] = {}
		global default_state
		self._Our_Articles_Headline = Flex(new_state, default_state["Our_Articles_Headline"])
	...
	@property
	def OA_All_Cards(self):
		self._getter_access_tracker["OA_All_Cards"] = {}
		return self._OA_All_Cards
	@OA_All_Cards.setter
	def OA_All_Cards(self, new_state):
		self._setter_access_tracker["OA_All_Cards"] = {}
		global default_state
		self._OA_All_Cards = Flex(new_state, default_state["OA_All_Cards"])

	@property
	def OA_Cards_Left(self):
		self._getter_access_tracker["OA_Cards_Left"] = {}
		return self._OA_Cards_Left
	@OA_Cards_Left.setter
	def OA_Cards_Left(self, new_state):
		self._setter_access_tracker["OA_Cards_Left"] = {}
		global default_state
		self._OA_Cards_Left = Flex(new_state, default_state["OA_Cards_Left"])

	@property
	def OA_Cards_Right(self):
		self._getter_access_tracker["OA_Cards_Right"] = {}
		return self._OA_Cards_Right
	@OA_Cards_Right.setter
	def OA_Cards_Right(self, new_state):
		self._setter_access_tracker["OA_Cards_Right"] = {}
		global default_state
		self._OA_Cards_Right = Flex(new_state, default_state["OA_Cards_Right"])

	@property
	def OA_Cards_Right_Row1(self):
		self._getter_access_tracker["OA_Cards_Right_Row1"] = {}
		return self._OA_Cards_Right_Row1
	@OA_Cards_Right_Row1.setter
	def OA_Cards_Right_Row1(self, new_state):
		self._setter_access_tracker["OA_Cards_Right_Row1"] = {}
		global default_state
		self._OA_Cards_Right_Row1 = Flex(new_state, default_state["OA_Cards_Right_Row1"])

	@property
	def OA_Card(self):
		self._getter_access_tracker["OA_Card"] = {}
		return self._OA_Card
	@OA_Card.setter
	def OA_Card(self, new_state):
		self._setter_access_tracker["OA_Card"] = {}
		global default_state
		self._OA_Card = Flex(new_state, default_state["OA_Card"])
	...
	@property
	def Book_Your_Table_Now(self):
		self._getter_access_tracker["Book_Your_Table_Now"] = {}
		return self._Book_Your_Table_Now
	@Book_Your_Table_Now.setter
	def Book_Your_Table_Now(self, new_state):
		self._setter_access_tracker["Book_Your_Table_Now"] = {}
		global default_state
		self._Book_Your_Table_Now = Flex(new_state, default_state["Book_Your_Table_Now"])

	@property
	def BYTN_Left(self):
		self._getter_access_tracker["BYTN_Left"] = {}
		return self._BYTN_Left
	@BYTN_Left.setter
	def BYTN_Left(self, new_state):
		self._setter_access_tracker["BYTN_Left"] = {}
		global default_state
		self._BYTN_Left = Flex(new_state, default_state["BYTN_Left"])
	...
	@property
	def BYTN_Right(self):
		self._getter_access_tracker["BYTN_Right"] = {}
		return self._BYTN_Right
	@BYTN_Right.setter
	def BYTN_Right(self, new_state):
		self._setter_access_tracker["BYTN_Right"] = {}
		global default_state
		self._BYTN_Right = Flex(new_state, default_state["BYTN_Right"])

	@property
	def BYTN_Form(self):
		self._getter_access_tracker["BYTN_Form"] = {}
		return self._BYTN_Form
	@BYTN_Form.setter
	def BYTN_Form(self, new_state):
		self._setter_access_tracker["BYTN_Form"] = {}
		global default_state
		self._BYTN_Form = Flex(new_state, default_state["BYTN_Form"])

	@property
	def BYTN_Form_Row(self):
		self._getter_access_tracker["BYTN_Form_Row"] = {}
		return self._BYTN_Form_Row
	@BYTN_Form_Row.setter
	def BYTN_Form_Row(self, new_state):
		self._setter_access_tracker["BYTN_Form_Row"] = {}
		global default_state
		self._BYTN_Form_Row = Flex(new_state, default_state["BYTN_Form_Row"])

	@property
	def BYTN_Form_LabelAndInput(self):
		self._getter_access_tracker["BYTN_Form_LabelAndInput"] = {}
		return self._BYTN_Form_LabelAndInput
	@BYTN_Form_LabelAndInput.setter
	def BYTN_Form_LabelAndInput(self, new_state):
		self._setter_access_tracker["BYTN_Form_LabelAndInput"] = {}
		global default_state
		self._BYTN_Form_LabelAndInput = Flex(new_state, default_state["BYTN_Form_LabelAndInput"])
	...
	@property
	def Follow_Us_On_Insta_Flex(self):
		self._getter_access_tracker["Follow_Us_On_Insta_Flex"] = {}
		return self._Follow_Us_On_Insta_Flex
	@Follow_Us_On_Insta_Flex.setter
	def Follow_Us_On_Insta_Flex(self, new_state):
		self._setter_access_tracker["Follow_Us_On_Insta_Flex"] = {}
		global default_state
		self._Follow_Us_On_Insta_Flex = Flex(new_state, default_state["Follow_Us_On_Insta_Flex"])

	@property
	def FUOI_Header_Button(self):
		self._getter_access_tracker["FUOI_Header_Button"] = {}
		return self._FUOI_Header_Button
	@FUOI_Header_Button.setter
	def FUOI_Header_Button(self, new_state):
		self._setter_access_tracker["FUOI_Header_Button"] = {}
		global default_state
		self._FUOI_Header_Button = Flex(new_state, default_state["FUOI_Header_Button"])
	...
	@property
	def FUOI_Images(self):
		self._getter_access_tracker["FUOI_Images"] = {}
		return self._FUOI_Images
	@FUOI_Images.setter
	def FUOI_Images(self, new_state):
		self._setter_access_tracker["FUOI_Images"] = {}
		global default_state
		self._FUOI_Images = Flex(new_state, default_state["FUOI_Images"])

	@property
	def FUOI_Images_Right(self):
		self._getter_access_tracker["FUOI_Images_Right"] = {}
		return self._FUOI_Images_Right
	@FUOI_Images_Right.setter
	def FUOI_Images_Right(self, new_state):
		self._setter_access_tracker["FUOI_Images_Right"] = {}
		global default_state
		self._FUOI_Images_Right = Flex(new_state, default_state["FUOI_Images_Right"])

	@property
	def FUOI_Right_Row_1(self):
		self._getter_access_tracker["FUOI_Right_Row_1"] = {}
		return self._FUOI_Right_Row_1
	@FUOI_Right_Row_1.setter
	def FUOI_Right_Row_1(self, new_state):
		self._setter_access_tracker["FUOI_Right_Row_1"] = {}
		global default_state
		self._FUOI_Right_Row_1 = Flex(new_state, default_state["FUOI_Right_Row_1"])

	@property
	def FUOI_Right_Row2(self):
		self._getter_access_tracker["FUOI_Right_Row2"] = {}
		return self._FUOI_Right_Row2
	@FUOI_Right_Row2.setter
	def FUOI_Right_Row2(self, new_state):
		self._setter_access_tracker["FUOI_Right_Row2"] = {}
		global default_state
		self._FUOI_Right_Row2 = Flex(new_state, default_state["FUOI_Right_Row2"])

	@property
	def Footer_Flex(self):
		self._getter_access_tracker["Footer_Flex"] = {}
		return self._Footer_Flex
	@Footer_Flex.setter
	def Footer_Flex(self, new_state):
		self._setter_access_tracker["Footer_Flex"] = {}
		global default_state
		self._Footer_Flex = Flex(new_state, default_state["Footer_Flex"])

	@property
	def Footer_Flex_Left(self):
		self._getter_access_tracker["Footer_Flex_Left"] = {}
		return self._Footer_Flex_Left
	@Footer_Flex_Left.setter
	def Footer_Flex_Left(self, new_state):
		self._setter_access_tracker["Footer_Flex_Left"] = {}
		global default_state
		self._Footer_Flex_Left = Flex(new_state, default_state["Footer_Flex_Left"])
	...
	@property
	def Footer_Flex_Mid(self):
		self._getter_access_tracker["Footer_Flex_Mid"] = {}
		return self._Footer_Flex_Mid
	@Footer_Flex_Mid.setter
	def Footer_Flex_Mid(self, new_state):
		self._setter_access_tracker["Footer_Flex_Mid"] = {}
		global default_state
		self._Footer_Flex_Mid = Flex(new_state, default_state["Footer_Flex_Mid"])

	@property
	def Footer_Mid_List(self):
		self._getter_access_tracker["Footer_Mid_List"] = {}
		return self._Footer_Mid_List
	@Footer_Mid_List.setter
	def Footer_Mid_List(self, new_state):
		self._setter_access_tracker["Footer_Mid_List"] = {}
		global default_state
		self._Footer_Mid_List = Flex(new_state, default_state["Footer_Mid_List"])
	...
	@property
	def Footer_Flex_Right(self):
		self._getter_access_tracker["Footer_Flex_Right"] = {}
		return self._Footer_Flex_Right
	@Footer_Flex_Right.setter
	def Footer_Flex_Right(self, new_state):
		self._setter_access_tracker["Footer_Flex_Right"] = {}
		global default_state
		self._Footer_Flex_Right = Flex(new_state, default_state["Footer_Flex_Right"])
	...
	@property
	def Order_Online_Button(self):
		self._getter_access_tracker["Order_Online_Button"] = {}
		return self._Order_Online_Button
	@Order_Online_Button.setter
	def Order_Online_Button(self, new_state):
		self._setter_access_tracker["Order_Online_Button"] = {}
		global default_state
		self._Order_Online_Button = Button(new_state, default_state["Order_Online_Button"])
	...
	@property
	def About_Us_Image(self):
		self._getter_access_tracker["About_Us_Image"] = {}
		return self._About_Us_Image
	@About_Us_Image.setter
	def About_Us_Image(self, new_state):
		self._setter_access_tracker["About_Us_Image"] = {}
		global default_state
		self._About_Us_Image = Image(new_state, default_state["About_Us_Image"])
	...
	def Location_Icon(self):
		self._getter_access_tracker["Location_Icon"] = {}
		return self._Location_Icon
	@Location_Icon.setter
	def Location_Icon(self, new_state):
		self._setter_access_tracker["Location_Icon"] = {}
		global default_state
		self._Location_Icon = Image(new_state, default_state["Location_Icon"])
	...
	@property
	def About_U(self):
		self._getter_access_tracker["About_U"] = {}
		return self._About_U
	@About_U.setter
	def About_U(self, new_state):
		self._setter_access_tracker["About_U"] = {}
		global default_state
		self._About_U = TextBox(new_state, default_state["About_U"])

	@property
	def About_Us_Lorem1(self):
		self._getter_access_tracker["About_Us_Lorem1"] = {}
		return self._About_Us_Lorem1
	@About_Us_Lorem1.setter
	def About_Us_Lorem1(self, new_state):
		self._setter_access_tracker["About_Us_Lorem1"] = {}
		global default_state
		self._About_Us_Lorem1 = TextBox(new_state, default_state["About_Us_Lorem1"])

	@property
	def About_Us_Lorem2(self):
		self._getter_access_tracker["About_Us_Lorem2"] = {}
		return self._About_Us_Lorem2
	@About_Us_Lorem2.setter
	def About_Us_Lorem2(self, new_state):
		self._setter_access_tracker["About_Us_Lorem2"] = {}
		global default_state
		self._About_Us_Lorem2 = TextBox(new_state, default_state["About_Us_Lorem2"])
	...
	@property
	def BOM2_Lorem(self):
		self._getter_access_tracker["BOM2_Lorem"] = {}
		return self._BOM2_Lorem
	@BOM2_Lorem.setter
	def BOM2_Lorem(self, new_state):
		self._setter_access_tracker["BOM2_Lorem"] = {}
		global default_state
		self._BOM2_Lorem = TextBox(new_state, default_state["BOM2_Lorem"])
	...
	@property
	def Price_1(self):
		self._getter_access_tracker["Price_1"] = {}
		return self._Price_1
	@Price_1.setter
	def Price_1(self, new_state):
		self._setter_access_tracker["Price_1"] = {}
		global default_state
		self._Price_1 = TextBox(new_state, default_state["Price_1"])
	...
	@property
	def Carouse(self):
		self._getter_access_tracker["Carouse"] = {}
		return self._Carouse
	@Carouse.setter
	def Carouse(self, new_state):
		self._setter_access_tracker["Carouse"] = {}
		global default_state
		self._Carouse = Div(new_state, default_state["Carouse"])
	...
	def _to_json_fields(self):
		return {
			"Flex2": self._Flex2,
			"Titles": self._Titles,
			"Home_About_etc": self._Home_About_etc,
			"Flex4": self._Flex4,
			"Flex7": self._Flex7,
			"Flex6": self._Flex6,
			"The_best_place_to_eat_burgers": self._The_best_place_to_eat_burgers,
			"Buttons_2": self._Buttons_2,
			"Flex10": self._Flex10,
			"Orange_background": self._Orange_background,
			"Order_from_favourite_app": self._Order_from_favourite_app,
			"Four_Images": self._Four_Images,
			"First_Two_Images": self._First_Two_Images,
			"Last_two_images": self._Last_two_images,
			"Browse_our_menu1": self._Browse_our_menu1,
			"Menu_Thumbnails": self._Menu_Thumbnails,
			"Menu_thumbnail_1": self._Menu_thumbnail_1,
			"Menu_thumbnail_2": self._Menu_thumbnail_2,
			"Menu_thumbnail_3": self._Menu_thumbnail_3,
			"Menu_thumbnail_4": self._Menu_thumbnail_4,
			"Buttons_in_menu1": self._Buttons_in_menu1,
			"About_Us": self._About_Us,
			"Image_and_Address": self._Image_and_Address,
			"Come_and_visit_us_block": self._Come_and_visit_us_block,
			"Flex28": self._Flex28,
			"Flex31": self._Flex31,
			"Flex32": self._Flex32,
			"About_Us_Flex": self._About_Us_Flex,
			"About_Us_Buttons": self._About_Us_Buttons,
			"Browse_Our_Menu2": self._Browse_Our_Menu2,
			"BOM2_Catalogue_Buttons": self._BOM2_Catalogue_Buttons,
			"Catalogue_Row_1": self._Catalogue_Row_1,
			"Catalogue_Row_1_Left": self._Catalogue_Row_1_Left,
			"Catalogue_Card_1": self._Catalogue_Card_1,
			"Price_Flex_1": self._Price_Flex_1,
			"Catalogue_Card_2": self._Catalogue_Card_2,
			"Flex41": self._Flex41,
			"Catalogue_Row_1_Right": self._Catalogue_Row_1_Right,
			"Flex45": self._Flex45,
			"Flex43": self._Flex43,
			"Flex46": self._Flex46,
			"Flex44": self._Flex44,
			"Catalogue_Row_2": self._Catalogue_Row_2,
			"Catalogue_Row_2_Right": self._Catalogue_Row_2_Right,
			"Flex52": self._Flex52,
			"Flex48": self._Flex48,
			"Flex53": self._Flex53,
			"Flex49": self._Flex49,
			"Catalogue_Row_2_Left": self._Catalogue_Row_2_Left,
			"Flex54": self._Flex54,
			"Flex50": self._Flex50,
			"Flex55": self._Flex55,
			"Flex51": self._Flex51,
			"BOM2_Buttons": self._BOM2_Buttons,
			"Most_Delicious_Burger": self._Most_Delicious_Burger,
			"MDB_Left": self._MDB_Left,
			"Flex62": self._Flex62,
			"MDB_Right": self._MDB_Right,
			"What_Our_Clients_Say_Flex": self._What_Our_Clients_Say_Flex,
			"Testimony_Flex": self._Testimony_Flex,
			"Testimony_Prev_Flex": self._Testimony_Prev_Flex,
			"Testimony_Next_Flex": self._Testimony_Next_Flex,
			"Testimony_Main": self._Testimony_Main,
			"Flex73": self._Flex73,
			"Profile_Flex": self._Profile_Flex,
			"Name_Place_Flex": self._Name_Place_Flex,
			"Flex77": self._Flex77,
			"Our_Articles": self._Our_Articles,
			"Our_Articles_Headline": self._Our_Articles_Headline,
			"Flex80": self._Flex80,
			"OA_All_Cards": self._OA_All_Cards,
			"OA_Cards_Left": self._OA_Cards_Left,
			"OA_Cards_Right": self._OA_Cards_Right,
			"OA_Cards_Right_Row1": self._OA_Cards_Right_Row1,
			"OA_Card": self._OA_Card,
			"Flex86": self._Flex86,
			"Flex89": self._Flex89,
			"Flex87": self._Flex87,
			"Flex88": self._Flex88,
			"Book_Your_Table_Now": self._Book_Your_Table_Now,
			"BYTN_Left": self._BYTN_Left,
			"Flex92": self._Flex92,
			"Flex95": self._Flex95,
			"Flex96": self._Flex96,
			"BYTN_Right": self._BYTN_Right,
			"BYTN_Form": self._BYTN_Form,
			"BYTN_Form_Row": self._BYTN_Form_Row,
			"BYTN_Form_LabelAndInput": self._BYTN_Form_LabelAndInput,
			...
			"Follow_Us_On_Insta_Flex": self._Follow_Us_On_Insta_Flex,
			"FUOI_Header_Button": self._FUOI_Header_Button,
			"Flex113": self._Flex113,
			"FUOI_Images": self._FUOI_Images,
			"FUOI_Images_Right": self._FUOI_Images_Right,
			"FUOI_Right_Row_1": self._FUOI_Right_Row_1,
			"FUOI_Right_Row2": self._FUOI_Right_Row2,
			"Footer_Flex": self._Footer_Flex,
			"Footer_Flex_Left": self._Footer_Flex_Left,
			"Flex121": self._Flex121,
			"Footer_Flex_Mid": self._Footer_Flex_Mid,
			"Footer_Mid_List": self._Footer_Mid_List,
			"Flex124": self._Flex124,
			"Footer_Flex_Right": self._Footer_Flex_Right,
